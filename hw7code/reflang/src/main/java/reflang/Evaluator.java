...
public class Evaluator implements Visitor<Value> {
	...
	public Value visit(RefExp e, Env env) {
		return heap.ref((Value) e.val().accept(this, env));
	}

	@Override
	public Value visit(DerefExp e, Env env) {
		return heap.deref((Value.RefVal) e.loc().accept(this, env));
	}
	...
	public Value visit(AssignExp e, Env env) {
		...
		Value loc_val = (Value) loc.accept(this, env);
		RefVal val_val  = (RefVal) val.accept(this, env);
		return heap.setref(val_val, loc_val);
	}
