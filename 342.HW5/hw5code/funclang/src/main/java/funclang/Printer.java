...
public class Printer {
	...
	public static class Formatter implements AST.Visitor<String> {
		...
		public String visit(AST.NumberExp e, Env env) {
			String result = "(null? ";
			result += e.arg().accept(this, env);
			return result + ")";
		}

		public String visit(AST.BooleanExp e, Env env) {
			String result = "(null? ";
			result += e.arg().accept(this, env);
			return result + ")";
		}
		...
		public String visit(AST.ProcedureExp e, Env env) {
			String result = "(null? ";
			result += e.arg().accept(this, env);
			return result + ")";
		}

		public String visit(AST.List_Exp e, Env env) {
			String result = "(null? ";
			result += e.arg().accept(this, env);
			return result + ")";
		}

		public String visit(AST.PairExp e, Env env) {
			String result = "(null? ";
			result += e.arg().accept(this, env);
			return result + ")";
		}
