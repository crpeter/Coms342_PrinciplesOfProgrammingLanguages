...
public interface AST {
	...
	public static class SwitchExp extends Exp {
		...
		public SwitchExp(Exp e0, List<Exp> bodies, List<Exp> cases, Exp defbody) {
			this.e0 = e0;
			this.bodies = bodies;
			this.cases = cases;
		...
		public Exp defbody() { return defbody; }

		public List<Exp> cases() { return cases; }

		public List<Exp> bodies() { return bodies; }
